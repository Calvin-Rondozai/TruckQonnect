 ...
 */
(function () {
  const LOGO = '../assets/images/logo.png.jpeg';
  const MENU = [
    { section: 'Operations' },
  ...
  window.TQLayout = {
    renderSidebar(container) {
      ...
      container.innerHTML = `
        ...
        <div class="p-3 border-top" style="border-color:var(--tq-border)!important">
    ...
    renderTopbar(container, title) {
      container.innerHTML = `
        ...
        <div class="tq-topbar-actions">
          <button class="tq-icon-btn" type="button" id="themeToggle" aria-label="Theme"><i class="bi bi-moon-stars-fill" id="themeIcon"></i></button>
