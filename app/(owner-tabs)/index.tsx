...
import {
  ...
  OwnerScreen,
  StatusBadge,
} from '@/components/owner/OwnerUIKit';
...
import { AVAILABLE_LOADS, OWNER_EARNINGS } from '@/lib/owner-mock-data';

export default function OwnerDashboard() {
  const { profile, setOnline } = useOwnerProfile();
    ...
    <OwnerScreen edges={['top']}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        <View style={styles.top}>
          ...
          <OnlineToggle online={profile.online} onToggle={() => setOnline(!profile.online)} />
        </View>
...
const styles = StyleSheet.create({
  ...
  name: { fontFamily: TQFonts.bold, fontSize: 22, color: OW.black },
  earnCard: {
    marginHorizontal: 20,
  ...
  sectionHead: { flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 20, marginBottom: 12 },
