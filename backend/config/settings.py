...
# Email (credentials only via environment / .env)
# Set EMAIL_USE_CONSOLE=True to print OTP emails in the terminal (dev only).
EMAIL_USE_CONSOLE = config('EMAIL_USE_CONSOLE', default=False, cast=bool)
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='')
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default=EMAIL_HOST_USER or 'noreply@truckqonnect.local')
